...
export const NOTES_DATA: NoteItem[] = [
  ...
  },
  {
    ...
    contentZh: '作品《旋转木马》是一个充满梦幻机械美学与动态触感回馈的交互式网页设计终端。设计采用 React 开发，将童年记忆中的双层木马旋转运动与网页底层的高帧率 3D 转换进行算法拟合。用户可以在虚拟空间数字媒介终端上，通过鼠标滚轮与画面动效相联动。这不仅是一个网页设计，更是一件让人在触屏上重拾童年重力与纯真节奏的数字交互艺术品。',
