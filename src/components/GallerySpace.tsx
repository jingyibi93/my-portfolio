...
const getProjectCardMetadata = (itemId: string, activeProjectItem: any, isEn: boolean): ProjectCardMeta => {
  ...
  switch (itemId) {
    ...
    case 'note-f5':
      return {
        name: name || (isEn ? "Carousel" : "旋转木马"),
        type: isEn ? "Web Design" : "网页设计",
        plotArea: "N/A",
        buildingArea: "N/A",
        role: isEn ? "Independent Web Designer" : "独立网页设计师",
        date: "07/2026",
        location: isEn ? "Virtual Space Digital Media Terminal" : "虚拟空间数字媒介终端",
        contribution: isEn 
          ? "Interactive Interface Design, Dynamic React Components, CSS 3D Transformation"
          : "网页交互界面设计、交互式网页设计终端研发、React动态组件重构"
      };
    default:
...
const getProjectImagesById = (itemId: string): string[] => {
  ...
  const fallbackImages: Record<string, string> = {
    ...
    'note-f5': 'https://i.postimg.cc/y8Nrf8hB/Screen-Shot-2026-07-06-214856-782.png',
